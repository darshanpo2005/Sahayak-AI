          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter teacher details to add them to the system.</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={(e) => handleFormSubmit(e, "Add Teacher")} className="space-y-4">
                  <div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter student details to enroll them.</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={(e) => handleFormSubmit(e, "Add Student")} className="space-y-4">
                  <div>
                    <Label htmlFor="studentName">Full Name</Label>
                    <Input id="studentName" placeholder="e.g., John Smith" required />
                  </div>
                  <div>
                    <Label htmlFor="studentGrade">Grade</Label>
                    <Input id="studentGrade" placeholder="e.g., 10th Grade" required />
                  </div>
                  <div>
                    <Label htmlFor="assignedTeacher">Assigned Teacher</Label>
                    <Input id="assignedTeacher" placeholder="e.g., Jane Doe" required />
                  </div>
                  <Button type="submit" className="w-full">
